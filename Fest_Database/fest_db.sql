...
VALUES(10, "Ryan", "Nguyen", '2016-12-21', 'Ryan@gamil.com', 0213123, 'adelaide', 12, 'Australia', 'SA', 5000, true );

INSERT INTO users (first_name, last_name, dob, email, contact_number, city, street, country, state, post_code, is_admin )
VALUES("James", "Santos", '2016-12-21', 'James@gamil.com', 0213123, 'adelaide', 12, 'Australia', 'SA', 5000, true );

INSERT INTO users (first_name, last_name, dob, email, contact_number, city, street, country, state, post_code, is_admin )
VALUES("Carlos", "Jack", '2016-12-21', 'Carlos@gamil.com', 0213123, 'adelaide', 12, 'Australia', 'SA', 5000, true);
